...
int main(void)
{
     ...
     * reach exactly three allocation sites -- the unit record and both text
     * buffers. A change here means a site was added, removed, or stopped
     * being reachable, and it should be re-blessed deliberately rather than
     * relaxed. Without it, deleting a seam silently shrinks the sweep and
